# -*- coding: utf-8 -*-
#
# wheezy.validation documentation build configuration file, created by
...
htmlhelp_basename = 'wheezy.validationdoc'
...
# [howto/manual]).
latex_documents = [
    ('index', 'wheezy.validation.tex', u'wheezy.validation Documentation',
...
man_pages = [
    ('index', 'wheezy.validation', u'wheezy.validation Documentation',
